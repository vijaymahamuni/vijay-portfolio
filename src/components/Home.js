...
const Home = () => {
  ...
  return (
    <main className="bg-gray-100 dark:bg-[#0a192f] flex-grow text-black dark:text-white">
        ...
        <div>
          <div className="block lg:hidden ">
            <img
              ...
              className="w-40 rounded-full max-md:ml-[100px] lg:ml-24"
              alt=""
            />
          </div>
          <h1 className="lg:text-4xl max-sm:text-lg sm:text-2xl md:text-3xl font-bold max-md:mt-4 max-md:text-center">
            Hey, I am Vijay
          </h1>
          <h1
      ...
      <div className="sm:w-10/12 md:w-10/12 lg:w-11/12 xl:w-9/12 lg:ml-[185px] mt-32 mb-16">
        <FootingPage />
      </div>
    </main>
  );
