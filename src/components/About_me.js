    ...
    <main className=" flex-grow bg-gray-100 dark:bg-[#0a192f]  text-black dark:text-white">
      <div className="mx-auto w-full md:w-9/12 max-md:h-[104%] lg:w-8/12 xl:w-9/12  max-sm:pt-2 md:pt-12 max-sm:ml-2">
        <div>
          ...
          {/* <div className="mx-auto max-sm:w-9/12 max-md:w-8/12">
            <img
              ...
              className="w-40  max-sm:mx-auto max-md:mx-auto lg:ml-"
              alt=""
            />
          ...
          <div className="flex flex-col items-center rounded-lg ">
            ...
            />
            <p className="text-lg font-semibold mt-10  text-center text-green-700">
              IF "PLAN A" DIDN'T WORK ,THE ALPHABET HAS 25 MORE LETTERS!
              <span className="text-[#ea6024] ml-2 ">STAY COOL</span>
            </p>
          </div>
          <div className="mx-auto lg:w-9/12 mt-10">
            <Box sx={{ maxWidth: "md" }}>
              <List>
                <ListItem>
                  <ListItemText
                    className="font-din"
                    primary="React Developer & Data Analyst – With three years of experience, I have built expertise in React.js and WebFOCUS, crafting dynamic, user-friendly interfaces and data-driven applications. My primary focus is frontend development, creating seamless and engaging user experiences."
                  />
                </ListItem>
